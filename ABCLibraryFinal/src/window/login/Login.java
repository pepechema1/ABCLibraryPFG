...
import window.librarian.LibrarianWindo;
	...
	private void validar(){
        ...
        if (!"".equals(user) || !"".equals(pass)) {
            ...
            if (usuario.getUsuario()!= null && usuario.getNombre() != null) {
                LibrarianWindo panel = new LibrarianWindo(usuario.getNombre());
                panel.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Usuario o la Contrase̱a incorrecta");
            }
        }
        }
